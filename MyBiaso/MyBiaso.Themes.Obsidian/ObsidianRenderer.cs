...
namespace MyBiaso.Themes.Obsidian {
    ...
    /// </summary>
    public class ObsidianRenderer : ToolStripProfessionalRenderer {
        ...
        private static Color _textMenuStripItem = Color.Black;// _c2;
        private static Color _textStatusStripItem = Color.Black; //_c2;
        private static Color _textContextMenuItem = Color.Black; //_c2;
        ...
        private static Color _gripDark = Color.FromArgb(71, 75, 84);
