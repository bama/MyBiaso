...
namespace MyBiaso.Themes.Obsidian {
    /// <summary>
    /// Provide Obsidian Theme colors
    /// </summary>
    public class ObsidianColorTable : ProfessionalColorTable {
        #region Static Fixed Colors - Obisidian Color Scheme
        ...
        private static Color _gripDark = Color.FromArgb(20, 20, 20);
        ...
        private static Color _overflowBegin = Color.Black;
        ...
        private static Color _menuToolBack = Color.FromArgb(163, 197, 242);

        private static Color _separatorDark = Color.FromArgb(154, 198, 255);
        private static Color _separatorLight = Color.FromArgb(248, 247, 243);
        private static Color _statusStripLight = Color.FromArgb(176, 210, 255);
        private static Color _statusStripDark = Color.FromArgb(222, 236, 255);
        private static Color _toolStripBorder = Color.Black;
        private static Color _toolStripContentEnd = Color.Black;
        private static Color _toolStripBegin = Color.FromArgb(220, 240, 255);
        private static Color _toolStripMiddle = Color.FromArgb(207, 218, 246);
        private static Color _toolStripEnd = Color.FromArgb(130, 165, 219);
        private static Color _buttonBorder = Color.Black;
        #endregion

        #region Identity
        /// <summary>
        /// Initialize a new instance of the Obsidian class.
        /// </summary>
        public ObsidianColorTable() {
        }
        #endregion
